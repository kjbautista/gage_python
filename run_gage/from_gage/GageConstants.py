...
TxMODE_MULTISEGMENTS    = 0x40000000 # Transfer data in raw data format with timestamp (all channels)
TxMODE_DEFAULT          = 0x00
...
CS_ONE_SAMPLE_DEPTH_RESOLUTION = 20 # Enabled one sample depth resolution. Disabled by default
...
# Set/Get ADC delay clock for Decade 6G
# Use with CsSet(), to set clock internal/external ADC delay using PCS_ADC_DELAY_STRUCT
# Use with csGet9), to get the current PCS_ADC_DELAY_STRUCT
CS_ADC_DELAY = 208
...
# PXI board type
CSHEXAGON_PXI_BOARDTYPE_MASK = 0x080
CSHEXAGON_LOWRANGE_BOARDTYPE_MASK =	0x040
CSHEXAGON_X161G4_BOARDTYPE = CSHEXAGON_PXI_BOARDTYPE_MASK | CSHEXAGON_161G4_BOARDTYPE
CSHEXAGON_X161G2_BOARDTYPE = CSHEXAGON_PXI_BOARDTYPE_MASK | CSHEXAGON_161G2_BOARDTYPE
CSHEXAGON_X16504_BOARDTYPE = CSHEXAGON_PXI_BOARDTYPE_MASK | CSHEXAGON_16504_BOARDTYPE
CSHEXAGON_X16502_BOARDTYPE = CSHEXAGON_PXI_BOARDTYPE_MASK | CSHEXAGON_16502_BOARDTYPE
CSHEXAGON_FIRST_BOARD      = CSHEXAGON_161G4_BOARDTYPE
CSHEXAGON_LAST_BOARD	   = CSHEXAGON_X16502_BOARDTYPE

# Dagger
# PCIe board type
CSDAGGER_50216_BOARDTYPE = 0x901
CSDAGGER_25216_BOARDTYPE = 0x902
CSDAGGER_FIRST_BOARD     = CSDAGGER_50216_BOARDTYPE
CSDAGGER_LAST_BOARD      = CSDAGGER_25216_BOARDTYPE

# CompuScope PLX based board
PLX_BASED_BOARDTYPE      = 0x4000
# CompuScope CPCI
CPCI_BOARDTYPE           = 0x8000
...
# No data are passed. The return value determines availability of the feature.
CAPS_DEPTH_INCREMENT = 0x4B0000


# Query for the capability of the trigger delay increment using.
# No data are passed. The return value determines availability of the feature.
CAPS_TRIGGER_DELAY_INCREMENT  = 0x4C0000
