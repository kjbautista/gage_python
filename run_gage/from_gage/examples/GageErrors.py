...
CS_INVALID_EXTCLK_SAMPLESKIP     = -115  # Invalid External Clock Sample Skip
CS_CONFLICT_TRIG_DELAY           = -116  # Trigger Delay and Pre-trigger conflict
...
CS_CAPTURE_CALIBPULSE_TIMEOUT    = -232  # Cannot capture the Calibration Pulse
CS_CALIBPULSE_NOT_DETECTED       = -233  # Cannot detect the Calibration Pulse signal
CS_CALIBPULSE_INVALID            = -234  # The Calibration Pulse is invalid
CS_TAO_OUT_OF_RANGE              = -235  # The trigger address offset is out of range
...
CS_INVALID_DATA8_TRIG_DEPTH      = -414  # Invalid depth for 8-bits data
CS_INVALID_DATA8_SEGMENT_SIZE    = -415  # Invalid segment size for 8-bits data
CS_OPEN_FILE_ERROR               = -416  # File open/create error.
...
CS_STM_OVERTOLTAGE               = -805  # Channel Protection Fault while streaming data.
...
CS_HISTOGRAM_FULL                = -820  # Histogram full
CS_DDC_CORE_CONFIG_ERROR         = -821  # Error on DDC core configuration.
CS_OCT_CORE_CONFIG_ERROR         = -822  # Error on OCT core configuration.
CS_OCT_INVALID_CONFIG_PARAMS     = -823  # OCT Config Params is invalid.
